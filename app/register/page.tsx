        ...
        <section className="px-6 py-20 sm:px-10 md:px-12 lg:px-16">
          <div className="mx-auto max-w-5xl grid gap-16 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            <div className="space-y-6">
              ...
              <h1 className="text-5xl font-semibold text-white sm:text-6xl">Create your IPTV Apollo account.</h1>
              <p className="max-w-3xl text-lg leading-8 text-slate-400">
                Sign up for premium channel access, user dashboard insights, and fast activation support.
              </p>
            </div>
            <div className="rounded-[32px] border border-white/10 bg-slate-950/90 p-10 shadow-2xl shadow-slate-950/40">
              <form className="space-y-6">
                ...
                <FormField label="Confirm password" name="confirmPassword" type="password" placeholder="Repeat your password" />
